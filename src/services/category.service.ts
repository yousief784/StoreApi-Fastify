...
class CategoryService {
    ...
    findCategoriesAsTree = async () => {
        try {
            // this sql line return all categories with id, name, parent_id, level;  level: generated by CTE in mysql
            ...
            // pass categories to buildTree to return categories as a tree
    ...
    // this function depends on recursion
    // - how it work
    // work from parent and take this node until the end like
    // to understand more you can see tree.png, i created it see how it works
